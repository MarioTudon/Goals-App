    ...
    return (
        <>
            <aside className={`flex flex-col justify-start text-gray-700 bg-gray-100 h-full ${asideWidth} transition-all duration-slow shadow-md shadow-gray-400 absolute z-10`}>
                ...
                <button onClick={hideMenu} className='absolute top-1/2 right-0 bg-gray-100 translate-x-full w-4 h-16 flex items-center justify-center bg-gray rounded-r-full transition-all duration-medium z-20'>
