...
function Aside() {
    ...
    return (
        <>
            <aside className={`flex flex-col flex-nowrap text-gray-700 bg-gray-200 h-full md:w-60 ${asideWidth} relative transition-all duration-slow`}>
                <LinkButton href={'#'} text={'Goals List'}>
                    <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 ml-4 mr-3 group-hover:scale-110">
