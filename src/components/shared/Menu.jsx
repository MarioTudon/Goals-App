...
function Menu({ hideMenu, arrowRotation, arrowDirection, asideWidth }) {

    return (
        <>
            <aside className={`flex flex-col justify-start text-gray-700 bg-gray-200 h-full lg:w-60 ${asideWidth} transition-all duration-slow delay-75 shadow-md shadow-gray-400 absolute z-10 md:relative`}>
                <NavButton href={'#'} text={'Goals List'}>
                ...
                <button onClick={hideMenu} className='absolute top-1/2 right-0 bg-gray-200 translate-x-full w-8 h-16 flex items-center justify-center bg-gray rounded-r-full transition-all duration-medium md:hidden'>
