    ...
    return (
        <>
            <aside className={`flex flex-col justify-start text-gray-700 bg-gray-200 h-full md:w-60 ${asideWidth} relative transition-all duration-slow pr-2`}>
                ...
                <button onClick={hideElement} className='absolute top-1/2 right-0 bg-gray-200 translate-x-full w-8 h-16 flex items-center bg-gray rounded-r-full transition-all duration-medium md:hidden'>
